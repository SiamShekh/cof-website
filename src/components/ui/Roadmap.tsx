...
const Roadmap = () => {
    const Roadmap = [
        { index: 1, title: "Start of mining/community building" },
        { index: 2, title: "Introducing FB cards (Auction/Bidding competition)" },
        { index: 3, title: "Community vote's on Roadmap" },
        { index: 4, title: "NFT'S pools creation for participation" },
        { index: 5, title: "Community discussion on tokens cap" },
        { index: 6, title: "TGE (1st phase airdrop) / Continues mining for 2nd phase" },
        { index: 7, title: "Creation of reward pools (Holders rewards)" },
        { index: 8, title: "NFT'S minting/distribution" },
        { index: 9, title: "CD cards farming pools creation (Based on FB cards transaction counts)" },
        { index: 10, title: "Airdrop phase 2" },
        { index: 11, title: "CD cards competitive farming" },
        { index: 12, title: "Implementation and distribution of CD cards to the open Network" },
        { index: 13, title: "Hardware / Gaming integrations" }
    ];
